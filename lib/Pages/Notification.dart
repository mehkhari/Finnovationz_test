...
class _NotifyPageState extends State<NotifyPage> {
  ...
  List<String> stockTitle=['Stock market for beginners','Mutual funds foreigners','financial frauds','stock market terminology','Stock market for beginners','Mutual funds foreigners','financial frauds','stock market terminology'];
  @override
